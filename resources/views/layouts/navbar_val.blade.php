...
<body>
    <header>
        ...
        <div class="container navbarLogo">
            <a title="Dunes Kite Piles" href="{{ url('/val') }}" target="_self"><img src="svg/logo.svg" id="logo" alt="logo dkpiles"></a>
            <div class="row">
                ...
                <div class="botonesHead">
                    <!-- boton Whatsapp -->
                    <a title="whatsapp" href="https://wa.me/+34622861169/?text=Vuic%20posarme%20en%20contacte%20amb%20vosaltres" target="_blank" id="enlaceWhatsapp"><i class="fab fa-whatsapp"></i></a>
                    <!-- end boton Whatsapp -->
                </div>
                <div class="botonesHead">
                    <!-- idioma -->
                    <a title="español" href="{{ url('/') }}">Esp</a>
                    <!-- end idioma -->
                </div>
                <!-- boton Login -->
                @guest
    ...
    <footer>
        ...
        <nav id="nav-mobile">
            ...
            <div id="wrap-items" class="menu-close">
                ...
                <span class="wrap-item">
                    <a href="{{ url('/val/temps') }}" id="tiempo">+ Previsions</a>
                </span>
                <span class="wrap-item">
                    <a href="{{ url('/val/webcams') }}" id="webcams">Webcams</a>
                </span>
                <span class="wrap-item">
                    <a href="{{ url('/val/contacte') }}" id="contacto">Contacte</a>
                </span>

                <span class="wrap-item">
                    <a href="{{ url('/val/galeria') }}" id="galeria">Galeria</a>
                </span>
                <span class="wrap-item">
                    <a href="{{ url('/val/mercadillo') }}" id="mercadillo">Mercadillo</a>
                </span>
                <span class="wrap-item">
                    <a href="{{ url('/val/noticies') }}" id="noticias">Noticies</a>
                </span>
